...
from rhucrl.agent.maximin_agent import get_maximin_agent_class
...
agent_ = get_maximin_agent_class(getattr(agent_module, f"{base_agent}Agent"))
agent = agent_.default(environment)
